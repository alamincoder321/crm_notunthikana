...
<div id="message">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="card">
                <strong>Client Name: </strong> <?php echo $rent_client->Customer_Name; ?><br>
                <strong>Mobile: </strong> <?php echo $rent_client->Customer_Mobile; ?><br>
                <strong>Area: </strong> <?php echo $rent_client->Customer_Address; ?>
            </div>
...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            saveMessage() {
                let url = "/add_rent_report";
                if (this.message.id != '') {
                    url = "/update_rent_report";
                }
