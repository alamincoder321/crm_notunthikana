...
<?php
    ...
    public function report_entry()
    {
        ...
        $data['content'] = $this->load->view('Administrator/reports/report_entry', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    ...
    public function add_report()
    {
        ...
        try {
            ...
            $this->db->insert('tbl_client_report', $customer);
            $customerId = $this->db->insert_id();

            $this->db->where("Customer_SlNo", $customerObj->client_id)->update('tbl_customer', ['status' => 'a']);
            ...
            if (!empty($_FILES)) {
                ...
                $imageName = rand(100000000, 999999999);
                ...
                $this->db->query("update tbl_client_report set report_file = ? where id = ?", [$imageName, $customerId]);
            }
    ...
    public function get_reports()
    {
        ...
        if (isset($data->client_id) && $data->client_id != null) {
            $clause .= " and r.client_id = '$data->client_id'";
        }

        if (isset($data->user_id) && $data->user_id != null) {
            $clause .= " and r.user_id = '$data->user_id'";
        }
        if (isset($data->Customer_Code) && $data->Customer_Code != null) {
            $clause .= " and c.Customer_Code = '$data->Customer_Code'";
        }
        ...
        if (isset($data->Customer_Type) && $data->Customer_Type != null) {
            $clause .= " and c.Customer_Type = '$data->Customer_Type'";
        }

        if (isset($data->client_status) && $data->client_status != null) {
            $clause .= " and r.client_status = '$data->client_status'";
        }
        ...
        $customers = $this->db->query("
            select
                ...
                d.District_Name,
                u.User_Name
            from tbl_client_report r
            join tbl_customer c on c.Customer_SlNo = r.client_id
        ...
        //     $customers = array_filter($customers, function ($item) use ($userId) {
        //         return $item->User_SlNo == $userId || $item->user_id == $userId;
        //     });
        // }
    ...
    public function delete_report()
    {
        ...
        try {
            ...
            $this->db->query("update tbl_client_report set status = 'd' where id = ?", $data->reportId);
    ...
    public function update_report()
    {
        ...
        try {
            ...
            $this->db->where('id', $customerId)->update('tbl_client_report', $customer);
    ...
    function report_list()
    {
        ...
        $data['content'] = $this->load->view('Administrator/reports/report_list', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }

    public function primary_requirement_entry()
    {
        $access = $this->mt->userAccess();
        if (!$access) {
            redirect(base_url());
        }
        $data['title'] = "Primary Requirement Entry";
        $data['content'] = $this->load->view('Administrator/primary_requirements/primary_requirement_entry', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }

    public function add_primary_requirement()
    {
        $res = ['success' => false, 'message' => ''];
        try {
            $customerObj = json_decode($this->input->post('data'));
            ...
            $this->db->insert('tbl_client_primary_requirement', $customer);
            $customerId = $this->db->insert_id();

            $res_message = 'Primary Requirement added successfully';


            if (!empty($_FILES)) {
                $config['upload_path'] = './uploads/primary_requirements/';
                $config['allowed_types'] = '*';
                ...
                $this->db->query("update tbl_client_primary_requirement set primary_requirement_file = ? where id = ?", [$imageName, $customerId]);
            }
    ...
    public function get_primary_requirements()
    {
        $data = json_decode($this->input->raw_input_stream);
        ...
        if (isset($data->primary_requirement_status) && $data->primary_requirement_status != null) {
            $clause .= " and r.primary_requirement_status = '$data->primary_requirement_status'";
        }

        if (isset($data->dateFrom) && $data->dateFrom != '' && isset($data->dateTo) && $data->dateTo != '') {
            $clause .= " and r.primary_requirement_date between '$data->dateFrom' and '$data->dateTo'";
        }
        ...
        $customers = $this->db->query("
            select
                ...
                u.User_Name,
                e.Employee_Name
            from tbl_client_primary_requirement r
            left join tbl_customer c on c.Customer_SlNo = r.client_id
            left join tbl_district d on d.District_SlNo = c.area_ID
            left join tbl_type t on t.id = c.type_id
            left join tbl_employee e on e.Employee_SlNo = r.employee_id
            left join tbl_user u on u.User_SlNo = r.user_id
            where r.status = 'a'
            $clause
            order by r.id desc
    ...
    public function delete_primary_requirement()
    {
        $res = ['success' => false, 'message' => ''];
        try {
            $data = json_decode($this->input->raw_input_stream);

            $this->db->query("update tbl_client_primary_requirement set status = 'd' where id = ?", $data->primary_requirementId);
    ...
    public function update_primary_requirement()
    {
        $res = ['success' => false, 'message' => ''];
        try {
            $customerObj = json_decode($this->input->post('data'));
            ...
            $this->db->where('id', $customerId)->update('tbl_client_primary_requirement', $customer);
    ...
    function primary_requirement_list()
    {
        $access = $this->mt->userAccess();
        if (!$access) {
            redirect(base_url());
        }
        $data['title'] = "Primary Requirement List";
        $data['content'] = $this->load->view('Administrator/primary_requirements/primary_requirement_list', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    ...
    function specialReport()
    {
        ...
        //     redirect(base_url());
        // }
        $data['title'] = "Special Report";
        $data['content'] = $this->load->view('Administrator/reports/special_report', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
}
